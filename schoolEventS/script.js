...
window.addEventListener("DOMContentLoaded", () => {
  ...
  function saveProgress() {
    localStorage.setItem("schoolEventSxpr", xp);
    localStorage.setItem("schoolEventSlevelr", level);
  }

  function loadProgress() {
    const savedXP = localStorage.getItem("schoolEventSxpr");
    const savedLevel = localStorage.getItem("schoolEventSlevelr");
