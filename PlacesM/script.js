...
function saveProgress() {
  localStorage.setItem("placesMxpr", xp);
  localStorage.setItem("placesMlevelr", level);
}

function loadProgress() {
  const savedXP = localStorage.getItem("placesMxpr");
  const savedLevel = localStorage.getItem("placesMlevelr");
