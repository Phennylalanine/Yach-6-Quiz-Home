...
function saveProgress() {
  localStorage.setItem("BuilingSSxp", xp);
  localStorage.setItem("BuildingSlevel", level);
}

function loadProgress() {
  const savedXP = localStorage.getItem("BuildingSxp");
  const savedLevel = localStorage.getItem("BuildingSlevel");
