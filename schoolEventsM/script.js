window.addEventListener("DOMContentLoaded", () => {
  ...
  function saveProgress() {
    localStorage.setItem("schoolEventMxpr", xp);
    localStorage.setItem("schoolEventMlevelr", level);
  }

  function loadProgress() {
    const savedXP = localStorage.getItem("schoolEventMxpr");
    const savedLevel = localStorage.getItem("schoolEventMlevelr");
